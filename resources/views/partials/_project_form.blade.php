@if (isset($project))
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <label for="stratum">Estrato Social</label>
...
<!-- have to check this source since elseif start's to the end, testing each piece of code -->
...
<div class="col-md-4">
    ...
    <label for="phone2">Teléfono 2 (Opcional)</label>
    <input type="tel" id="phone2" name="phone2" class="form-control" value="{{ old('phone2') }}">
  </div>
  <div class="col-md-4">
  <label for="cellphone">Número Celular</label>
  <input type="tel" id="cellphone" name="cellphone" class="form-control" value="{{ old('cellphone') }}">
  </div>
  </div>
  <div class="row">
    <div class="col-md-4">
  ...
  <div class="col-md-4">
    ...
    <div class="col-md-4">
    <label for="price">Precio base (inicial)</label>
      <input type="price" min="1" step="1" id="floors" name="price" value="{{ old('price') }}">
    </div>
    </div>
...
<div class="row">
    ...
    <textarea name="description" id="description" rows="8" cols="80" class="form-control" placeholder="Descripción del Proyecto">{{ old('description') }}</textarea>
