...
<div class="form-group">
  <label for="unit_quantity">Cantidad Totales de <i>Inmuebles</i></label>
  <div class="input-group">
...
<div class="form-group">
  <label for="left_units">Número de Unidades Restantes<i>(Inmuebles)</i></label>
  <div class="input-group">
    <input type="text" id="left_units" name="left_units" class="form-control" value="{{ old('left_units') }}">
  </div>
</div>
...
<input type="hidden" name="images[]" data-source="{{ route('get_project_image_path', $image) }}" id="{{ preg_replace('/(.png|.jpg|.jpeg|.gif)/', '', $image) }}" value="{{ $image }}">
@endforeach
@endif
