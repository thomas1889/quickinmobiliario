		...
		<div class="container">
			<nav id="primary-menu">
				<ul class="main-menu text-center">
					<li><a href="{{ url('/') }}">
						<i class="fa fa-home fa-1x" aria-hidden="true"></i> Inicio</a></li>
						<li>
							<a href="#">
								<i class="fa fa-pencil fa-1x" aria-hidden="true"></i> Publicar</a>
								<ul class="drop-menu">
							...
							<li><a href="#">
								<i class="fa fa-universal-access fa-1x" aria-hidden="true"></i> Acelerador</a></li>
								<li><a href="{{ url('preciosyplanes') }}">
									<i class="fa fa-shopping-basket fa-1x" aria-hidden="true" alt="Ícono Canasta"></i> Planes</a></li>
									...
									<li><a href="{{ url('preguntasfrecuentes') }}">
										<i class="fa fa-life-ring" aria-hidden="true"></i> Ayuda</a></li>
									</ul>
								</nav>
							</div>
						</div>
