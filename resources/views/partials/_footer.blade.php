						...
						<ul class="footer-address">
							<li>
								<div class="address-icon">
									<i class="fa fa-map-marker fa-2x" aria-hidden="true" alt="Ícono ubicación"></i>
								</div>
								<div class="address-info">
									<span>Calle 94a # 11a 27,</span>
									<span>Bogotá, DC. 110011.</span>
								</div>
							</li>
							<li>
								<div class="address-icon">
							...
							<li>
								<div class="address-icon">
									<i class="fa fa-globe fa-2x" aria-hidden="true" alt="Ícono planeta"></i>
								</div>
								<div class="address-info">
