...
<div class="row">
	<div class="col-sm-8 col-md-offset-2">
		...
		<div class="embed-responsive embed-responsive-16by9">
			<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/{{ $project->video360 }}"></iframe>
		</div>
		<div class="row">
			<!-- @foreach($project->project_images as $image)
			<div class="col-xs-6 col-md-3">
			<a href="#" class="thumbnail">
			<img src="{{ route('get_project_image_path', $image->id )}}" alt={{ $project->name }}>
		</a>
	</div>
	@endforeach -->
</div>

		<p><strong>Viviendas asosiadas a este proyecto:</strong>
			<!-- aquí va el contenido de los inmuebles asosiados al proyecto -->
		</p>
